$(function () {
    ...
    var systemDimensions = {
        "snes": {
            ...
            sh: 2100,
            dx: (rotate) => {
                return rotate ? -3366 : -1832
            },
            dy: 0,
            dw: (rotate) => {
                return rotate ? 2100 : 1534
            },
            dh: (rotate) => {
                return rotate ? 1534 : 2100
            }
        },
        "neogeocd": {
            sw: 3225,
            sh: 2156,
            dx: (rotate) => {
                return rotate ? -3225 : -1687
            },
            dy: 0,
            dw: (rotate) => {
                return rotate ? 2154 : 1538
            },
            dh: (rotate) => {
                return rotate ? 1538 : 2154
            }
        },
        "genesismegadrive": {
            sw: 3366,
            sh: 2100,
            dx: (rotate) => {
                return rotate ? -3366 : -1835
            },
            dy: 0,
            dw: (rotate) => {
                return rotate ? 2156 : 1520
            },
            dh: (rotate) => {
                return rotate ? 1520 : 2156
            }
        }
    }
    ...
    function processImage(img) {
        ...
        c.toBlob(blob => {
            $("#mainImage").attr("src", URL.createObjectURL(blob));
        });
